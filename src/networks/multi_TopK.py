...
class TopKpool(torch.nn.Module):
    def __init__(self, cfg):
        ...
        self.pool = TopKPooling(self.nhid*self.num_layer, self.ratio)
    ...
    def forward(self, data):
        ...
        ################################################################################################################
        # TopKPool
        pooled_c1, edge_index_c1, edge_attr_c1, batch_c1, perm_c1, score_c1 = self.pool(x_c1, edge_index_c1, batch=batch_c1)
        pooled_c2, edge_index_c2, edge_attr_c2, batch_c2, perm_c2, score_c2 = self.pool(x_c2, edge_index_c2, batch=batch_c2)
        #################################################################################################################
